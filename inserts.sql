INSERT `company` (`AFM`, `DOY`, `name`, `phone`, `street'`, `num`, `city`, `country`) VALUES
...
INSERT `user` (`username`, `password`, `name`, `surname`, `regDate`, `email`) VALUES
...
INSERT `manager` (`managerUsername`, `experience`, `firm`) VALUES
('paraskevi99', 9, '555554444'),
('anaksiman', 3, '901234567'),
('dionysus04' 6, '123456789')
;

INSERT `evaluator` (`username`,`experience`, `firm`, `evaluatorID`) VALUES
('fotisz', 9, '555554444', 0000000001),
('pelagiakou', 7, '901234567', 0000000002),
('elenitsa9', 8, '012345345', 0000000003)
; 

INSERT `employee` (`username`, `firm`, `resume`, `sistatikes`, `certificates`, `awards`) VALUES
...
INSERT `degree` (`title`, `institution`, `bathmida`) VALUES
...
INSERT `has_degree` (`title`, `institution`, `emplUsername`, `etos`,  `grade`) VALUES
...
INSERT `project` (`employee`, `num`, `descr`, `url`) VALUES
('afroditimy', 1, 'A scrutny about ISE', 'https://github.com/afroditimy/ISE'),
('afroditimy', 2, 'Secure VPN access for remote workers', 'https://github.com/afroditimy/AnyConnect'),
('petrospap', 1, 'Application Programming Inteface connection to random website', 'https://github.com/petrospap/APIrandom'),
('petrospap', 2,  'SQL based Crud Web Application', 'https://github.com/petrospap/CRUDrandom'),
('panagopoulosa', 1, 'Holistic Platform Design for Smart Buildings of the Future Internet', 'https://github.com/panagopoulosa/hobnet'),
('panagopoulosa', 2, 'Research extending IoT testbed for multidisciplinary experiments', 'https://github.com/panagopoulosa/IoT'),
('panagopoulosa', 3, 'Crowd-sourcing based privacy protection for web applications', 'https://github.com/panagopoulosa/randomPrivacysetup'),
('matinaakrivi', 1, 'Population-Based Optimization Algorithms', 'https://github.com/matinaakrivi/stuff')
;

INSERT `job` (`ID`,  `startDate`, `salary` , `position`, `edra`, `evaluator`, `announcement_date`, `expiration_date`) VALUES
...
INSERT `antikeim` (`title`, `descr`, `parentField`) VALUES
...
INSERT `needs` (`jobID`, `fieldTitle`) VALUES
...
INSERT `request_evaluation` (`emplUsername`, `jobID`) VALUES
('afroditimy', '0001'),
('afroditimy', '0006'),
('petrospap', '0001'),
('petrospap', '0004'),
...
INSERT `evaluation` (`evaluationID`,`emplUsername`, `evalUsername`, `jobID`, `interviewGrade`, `reportGrade`, `recGrade`,`finalGrade`, `comments`, `completed`) VALUES
...
INSERT `languages` (`employee`, `language`) VALUES
('afroditimy', 'EN, FR, GR'),
('petrospap', 'EN, GR'),
