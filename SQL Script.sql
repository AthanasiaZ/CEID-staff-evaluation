...
-- Tue 07 Sep 2021 01:11:07 PM EEST
...
USE `mydb`;
DROP procedure IF EXISTS `mydb`.`manager1`;
...
USE `mydb`;
DROP procedure IF EXISTS `mydb`.`manager2`;
...
USE `mydb`;
DROP procedure IF EXISTS `mydb`.`manager7`;
...
USE `mydb`;
DROP procedure IF EXISTS `mydb`.`manager3`;
...
USE `mydb`;
DROP procedure IF EXISTS `mydb`.`manager6`;
...
USE `mydb`;
DROP procedure IF EXISTS `mydb`.`manager4`;
...
USE `mydb`;
DROP procedure IF EXISTS `mydb`.`admin2.1`;
...
USE `mydb`;
DROP procedure IF EXISTS `mydb`.`admin2.2`;
...
USE `mydb`;
DROP procedure IF EXISTS `mydb`.`employee1.2`;
...
USE `mydb`;
DROP procedure IF EXISTS `mydb`.`employee1.3`;
...
USE `mydb`;
DROP procedure IF EXISTS `mydb`.`employee1.1`;
...
USE `mydb`;
DROP procedure IF EXISTS `mydb`.`employee2`;
...
USE `mydb`;
DROP procedure IF EXISTS `mydb`.`employee3`;
...
USE `mydb`;
DROP procedure IF EXISTS `mydb`.`employee4`;
...
USE `mydb`;
DROP procedure IF EXISTS `mydb`.`evaluator1.1`;
...
USE `mydb`;
DROP procedure IF EXISTS `mydb`.`evaluator1.2`;
...
USE `mydb`;
DROP procedure IF EXISTS `mydb`.`evaluator2`;
...
USE `mydb`;
DROP procedure IF EXISTS `mydb`.`evaluator3.1`;
...
USE `mydb`;
DROP procedure IF EXISTS `mydb`.`evaluator3.2`;
...
USE `mydb`;
DROP procedure IF EXISTS `mydb`.`evaluator3.3`;
...
USE `mydb`;
DROP procedure IF EXISTS `mydb`.`evaluator4.1`;
...
USE `mydb`;
DROP procedure IF EXISTS `mydb`.`evaluator4.2`;
...
USE `mydb`;
DROP procedure IF EXISTS `mydb`.`evaluator7`;
